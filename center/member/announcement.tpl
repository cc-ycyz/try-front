        ...
        <div id="announcement">
            <div class="pk-announcement">
                <div class="pk-announcement-title">
                    ...
                    <div class="pk-announcement-title-btn" :class="activeNumber=== 2 ? 'activeed' : ''"
                         @click="btnmaintain()">维护公告
                    </div>
                    <div class="pk-announcement-title-btn" :class="activeNumber=== 3 ? 'activeed' : ''"
                         @click="btnnewest()">上新公告
                    </div>
                    <div class="pk-announcement-title-btn" :class="activeNumber=== 4 ? 'activeed' : ''"
                         @click="btnactivity()">活动公告
                    </div>
                    <div class="pk-announcement-title-btn" :class="activeNumber=== 5 ? 'activeed' : ''"
                         @click="btnganme()">游戏公告
                    </div>
                    <div class="pk-announcement-title-btn" :class="activeNumber=== 6 ? 'activeed' : ''"
                         @click="btnother()">其他
                    </div>
                </div>

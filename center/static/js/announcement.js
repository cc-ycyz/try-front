var vm = new Vue({
    ...
    methods: {
        ...
        notice(data, page) {
            ...
            console.log($("#pk_bet_page").val()*1,'1234567') ;
            _this.parmas.pageSize = $("#pk_bet_page").val()*1; 
            var post = {
                page: page,
        ...
        btnnewest() {
            window.location.href='/member/newset.tpl';
            // var _this = this;
            // this.activeNumber = 3;
            // _this.parmas.page = 1
        ...
        makeperPagepro1() {
            ...
            * */
            ...
            function pageChange(i) {
                ...
                console.log(totalCount, i + 1, _this.parmas, 'parmas',_this.parmas.pageSize)
